#!/bin/bash
cd $(dirname $0);
default_assign_first="央视频道,卫视频道,数字频道,电影频道,经典剧场,动画频道,体育频道,游戏频道,"
...
exclude_pd="湖南移动,YY轮播,哔哩轮播,斗鱼轮播,卫视备用,卫视高清,央视备用,央视高清,虎牙轮播,音乐频道,其他频道,地方频道,解说频道,春晚频道,体验频道,央视付费频道,咪咕直播,更新时间,"
